  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        ...
        <p class="lead text-body-secondary">Here you can see your staus of your complaint and also you can able to edit
          if you are booked your comaplint.</p>
        <p>
          <a href="/stud-panel/complaint/complaint-status" class="btn btn-secondary my-2 rounded-1">status of
            complaint</a>
