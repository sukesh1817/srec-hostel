...
<body>
    ...
    <div class="float-end mx-3 my-3">
        <a href="/comaplint/logs/" class="btn btn-sm btn-dark rounded-1">
                            ...
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <button src="/evidence-photo/?roll-no=<?php echo $row[$i]["roll_no"] ?>&w=i"
                        ...
                        <div class="col images">
                            <div class="card shadow-sm ">
                                ...
                                <div class="card-body">
                                    ...
                                    <br>
                                    Complaint Summary - <br> <strong><?php echo $row1[$i]["complaint_summary"] ?></strong>
                                    </p>
