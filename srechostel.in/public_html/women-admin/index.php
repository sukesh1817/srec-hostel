                ...
                <div class="row align-items-md-stretch">
                    <div class="col-md-6 mb-4">
                        <div class="h-100 p-5 bg-dark rounded-3">
                            ...
                            <p style="color:#fff">Here You Can See About The Token Records By Click The
                                Below
                                Button.</p>
                            <a href="/token-records" class="btn btn-outline-light rounded-1 btn-lg"
                                type="button">
                                See Details
                            </a>
                        </div>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="h-100 p-5 bg-body-tertiary border rounded-3">
                            ...
                            <a href="/accommodation" class="btn btn-outline-dark rounded-1 btn-lg"
                                type="button">
                                See Details
                            </a>
                        </div>
                ...
                <div class="row align-items-md-stretch">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="h-100 p-5 bg-body-tertiary border rounded-3">
                            ...
                            <a href="/complaint/" class="btn btn-dark rounded-1 btn-lg" type="button">
                                See Details
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="h-100 p-5 bg-dark rounded-3">
                            ...
                            <a href="/gate-pass/" class="btn btn-light rounded-1 text-dark btn-lg"
                                type="button">
                                See Details
                            </a>
                        </div>
                ...
                <div class="row align-items-md-stretch">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="h-100 p-5  bg-dark border rounded-3">
                            ...
                            <a href="/committee/" class="btn btn-outline-light rounded-1 btn-lg"
                                type="button">
                                See Details
                            </a>
                        </div>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="h-100 p-5  bg-body-tertiary border rounded-3">
                            ...
                            <a href="/food-orders/" class="btn btn-outline-dark rounded-1 btn-lg"
                                type="button">
                                See Details
                            </a>
                        </div>
                ...
                <div class="row align-items-md-stretch">
                    <div class="col-md-6 col-lg-12 mb-4">
                        <div class="h-100 p-5  bg-dark border rounded-3">
                            ...
                            <a href="/add-student-records/" class="btn btn-light rounded-1 btn-lg">
                                See Details
                            </a>
                        </div>
                    </div>
