...
<body>
    ...
    <div class="container mt-5">
        <p class='text-center fs-2'>Gate pass details</p>
        <hr>
        <div class="row mt-3">
            <div class="col-lg-4 col-md-6">
                <div class="card" style="width: 23rem;">
                    <form method="post" action="/admin-panel/gate-pass/search/">
                        <div class="card-body">
                            <h5 class="card-title">Men hostel 1</h5>
                            <h6 class="card-subtitle mb-2 text-body-secondary">Student details</h6>
                            <input type="hidden" name="hostel" value="Mens-1">
                ...
                <div class="card" style="width: 23rem;">
                    <form method="post" action="/admin-panel/gate-pass/search/">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle mb-2 text-body-secondary">Student details</h6>
                            <input type="hidden" name="hostel" value="Mens-2">
