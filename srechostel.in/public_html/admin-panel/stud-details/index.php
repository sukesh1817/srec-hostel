...
<body class="noto-sans">
    ...
    <div class="float-end mx-3 my-3">
        <button  type="button" class="btn btn-sm btn-danger rounded-1" data-bs-trigger="hover focus" data-bs-placement="left" data-bs-title="Popover title" data-bs-content="Want to delete user account click it">
