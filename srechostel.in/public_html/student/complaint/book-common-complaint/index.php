            ...
            <div class="m-3 d-flex justify-content-center">
                <div class="cont">
                    ...
                    <form class="needs-validation" action="/complaint/book-common-complaint/" method="post"
                        ...
                        <select class="form-select rounded-1 mb-2" id="dept" name="dept" aria-label="Default select example">
                            <option selected>Select your department</option>
                            <option value="B.Tech AIDS">AI&DS</option>
                            <option value="B.Tech IT">IT</option>
                            <option value="B.E ECE">ECE</option>
                            <option value="B.E EEE">EEE</option>
                            <option value="B.E EIE">EIE</option>
                            <option value="B.E CSE">CSC</option>
                            <option value="B.E RA">RA</option>
                            <option value="B.E MECH">MECH</option>
                            <option value="B.E AERO">AERO</option>
                            <option value="B.E BME">BME</option>
                            <option value="B.E CSE">CSC</option>
                            <option value="B.E CIVIL">CIVIL</option>
                            <option value="M.Tech CSE">M.CSC</option>
