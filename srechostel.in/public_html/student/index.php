...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="/images/icons/student-icon.png">

    <title>Welcome <?php if (isset($_SESSION['name'])) {
        echo $_SESSION['name'];
    } else {
        echo "Student";
    } ?></title>
...
<body>
    ...
    <div class="px-4 py-5 my-5 text-center" bis_skin_checked="1">
        ...
        <div class="col-lg-6 mx-auto" bis_skin_checked="1">
            <p class="lead">Welcome to the gate pass booking section of our website! Please follow the instructions to
                book
            ...
            <div class="row flex-lg-row-reverse align-items-center g-5 py-5" bis_skin_checked="1">
                <div class="col-10 col-sm-8 col-lg-6 d-flex" bis_skin_checked="1">
                    <img src="/images/layout-image/restaurant.png"
                        class="d-block mx-lg-5 img-fluid rounded-1 align-items-center justify-content-center"
                ...
                <div class="col-lg-6" bis_skin_checked="1">
                    ...
                    <p class="lead">By clicking the below button you book your food token and also you can the pervious
                        booking
