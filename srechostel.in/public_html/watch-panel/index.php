...
<div class="px-4 py-5 my-5 text-center">
    <img class="d-block mx-auto mb-4" src="/images/layout-image/security-guard.png" alt="" width="72" height="65">
    ...
    <div class="col-lg-6 mx-auto">
      ...
      <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
        <button id="entry-btn" type="button" class="btn btn-dark btn-lg px-4 gap-3 rounded-1">Click to entry</button>
      </div>
    </div>
  </div>
</div>
	<script src="https://unpkg.com/html5-qrcode"></script>
	<script src="/js-files/scan.js"></script>
</body>
